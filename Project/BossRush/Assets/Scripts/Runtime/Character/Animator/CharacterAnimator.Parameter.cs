...
namespace TeamSuneat
{
    public partial class CharacterAnimator : XBehaviour, IAnimatorStateMachine
    {
        ...
        private const string ANIMATOR_IS_DASHING_PARAMETER_NAME = "IsDashing";
        ...
        protected virtual void InitializeAnimatorParameters()
        {
            ...
            _animator.AddAnimatorParameterIfExists(ANIMATOR_IS_DASHING_PARAMETER_NAME, out ANIMATOR_IS_DASHING_PARAMETER_ID, AnimatorControllerParameterType.Bool, AnimatorParameters);
