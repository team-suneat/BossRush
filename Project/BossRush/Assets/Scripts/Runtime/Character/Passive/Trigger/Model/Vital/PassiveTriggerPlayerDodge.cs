...
{
    public class PassiveTriggerPlayerDodge : PassiveTriggerReceiver
    {
        private DamageResult damageResult = new DamageResult();
        protected override PassiveTriggers Trigger => PassiveTriggers.PlayerDodge;

        protected override void Register()
        {
            base.Register();

            GlobalEvent<DamageResult>.Register(GlobalEventType.PLAYER_CHARACTER_DODGE, OnGlobalEvent);
        }
        ...
        protected override void Unregister()
        {
            ...
            GlobalEvent<DamageResult>.Unregister(GlobalEventType.PLAYER_CHARACTER_DODGE, OnGlobalEvent);
        }
